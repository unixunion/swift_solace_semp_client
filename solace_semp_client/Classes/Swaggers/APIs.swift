...
public class solace_semp_clientAPI {
    public static var basePath = "http://www.solace.com/SEMP/v2/config"
...
public class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:AnyObject]?, isBody: Bool, headers: [String:String] = [:]) {
        ...
        addHeaders(solace_semp_clientAPI.customHeaders)
    }
    ...
    public func addCredential() -> Self {
        self.credential = solace_semp_clientAPI.credential
        return self
    }
}
